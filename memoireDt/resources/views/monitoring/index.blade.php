            ...
            @else
                            ...
                            <p class="text-center text-secondary h3">
                                ...
                                @endif
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                        viewBox="0 0 48 48">
                                        <g fill="none">
                                            <rect width="36" height="36" x="6" y="6" fill="#2F88FF"
                                                stroke="#000" stroke-width="4" rx="3" />
                                            <path fill="#fff"
                ...
                <div class="col-md-3 my-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-center text-secondary h3">
                                @if ($monitorings->qualite_air >= 0 && $monitorings->qualite_air <= 50)
                                    Très Bonne
                                @elseif ($monitorings->qualite_air >= 51 && $monitorings->qualite_air <= 100)
                                    Bonne
                                @elseif ($monitorings->qualite_air >= 101 && $monitorings->qualite_air <= 150)
                                    Modéré
                                @elseif ($monitorings->qualite_air >= 151 && $monitorings->qualite_air <= 200)
                                    Médiocre
                                @elseif ($monitorings->qualite_air >= 201 && $monitorings->qualite_air <= 300)
                                    Mauvais
                                @elseif ($monitorings->qualite_air > 300)
                                    Très Mauvais
                                @endif
                                {{ $monitorings->qualite_air }} ppm: Bonne
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                    viewBox="0 0 48 48">
                ...
                <div class="col-md-3 my-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-center text-secondary h3">
                                @if ($monitorings->temperature_ressentie < 20)
                                    Pas d'inconfort !
                                @elseif ($monitorings->temperature_ressentie >= 20 && $monitorings->temperature_ressentie < 30)
                                    Peu d'inconfort !
                                @elseif ($monitorings->temperature_ressentie >= 30 && $monitorings->temperature_ressentie < 40)
                                    Un certain inconfort !
                                @elseif ($monitorings->temperature_ressentie >= 40 && $monitorings->temperature_ressentie < 45)
